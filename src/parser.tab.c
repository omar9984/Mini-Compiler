...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "CHAR", "PLUS",
  "MINUS", "MULT", "DIV", "VAR", "EQUAL", "Minus", "POW", "IF", "ELIF",
...
{
     -24,     0,   -24,   -24,   -23,    -2,   -20,    11,    -2,   -24,
       3,   -24,    -2,    -2,    -2,    -2,    -2,    11,   -24,     5,
      -7,    -7,     5,    -7
};
...
{
       2,     3,     8,     3,    11,    16,     0,     9,    12,     4,
      13,    14,    13,    14,    15,    16,    12,    16,    13,    14,
       0,     0,    15,    16,     5,    10,     5,     0,    17,     0,
      18,     0,    19,    20,    21,    22,    23
};

static const yytype_int8 yycheck[] =
{
       0,     3,    25,     3,    24,    12,    -1,     9,     5,     9,
       7,     8,     7,     8,    11,    12,     5,    12,     7,     8,
      -1,    -1,    11,    12,    26,     5,    26,    -1,     8,    -1,
      27,    -1,    12,    13,    14,    15,    16
};
...
{
       0,    29,     0,     3,     9,    26,    30,    31,    25,     9,
      31,    24,     5,     7,     8,    11,    12,    31,    27,    31,
      31,    31,    31,    31
};
